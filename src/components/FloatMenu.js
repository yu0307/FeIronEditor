...
class Menu {
    ...
    constructor({ options, editorView }) {
        ...
        this.options.editor.on('mouseover', ({ view }) => {
            this.update(view)
        })
    ...
    update(view, lastState) {
        ...
        const parent = this.options.element.offsetParent ? this.options.element.offsetParent : this.options.element;
